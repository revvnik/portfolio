window.addEventListener("load", function () {
    ...
    if(check == false) { location.href = "#work"; }
    ...
    // Hide the loader and start the fade-out animation after randomDuration
    setTimeout(() => {

        overlay.style.animation = "fadeInAnimation ease 2s forwards"; // Start the fade-out animation

        // Remove the overlay after the animation ends
        setTimeout(() => {
            overlay.style.display = "none"; // Hide overlay completely
        }, 2000); // Match the fade-out animation duration
    }, randomDuration);
